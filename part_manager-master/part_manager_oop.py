...
class Application(tk.Frame):
    def __init__(self, master):
        ...
        self.master = master
        master.title('Accounting Calculation')
        # Width height
    ...
    def create_widgets(self):
        ...
        self.part_label = tk.Label(
            self.master, text='Purchase QTY', font=('bold', 14), pady=20)
        ...
        self.customer_label = tk.Label(
            self.master, text='Sale QTY', font=('bold', 14))
        ...
        self.retailer_label = tk.Label(
            self.master, text='Purchase Rate', font=('bold', 14))
        ...
        self.price_label = tk.Label(
            self.master, text='Sale Rate', font=('bold', 14))
        ...
        # Parts list (listbox)
        self.parts_list = tk.Listbox(self.master, height=25, width=100, border=0)
